...
export default function RichTextEditor({ value, onChange, placeholder = 'متن خبر را اینجا بنویسید...' }: RichTextEditorProps) {
  ...
  return (
    <div className="border border-slate-200 rounded-2xl bg-white shadow-sm focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-transparent transition-all relative">
      {/* Toolbar */}
      <div className="bg-slate-100 border-b border-slate-200 p-2.5 flex flex-wrap items-center gap-1.5 text-slate-700 select-none z-10 rounded-t-2xl">
        
        {/* Headings */}
        <button
          type="button"
          onClick={() => executeCommand('formatBlock', '<h1>')}
          className="p-2 bg-white text-slate-700 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all border border-slate-200 shadow-sm hover:border-blue-200 hover:shadow"
        ...
        <button
          ...
          className="px-2.5 py-1 text-xs font-bold bg-white text-slate-700 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all border border-slate-200 shadow-sm hover:border-blue-200 hover:shadow"
          title="متن عادی"
        >
          پاراگراف
        </button>
        ...
        <button
          ...
          className="p-2 bg-white text-slate-700 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all border border-slate-200 shadow-sm hover:border-blue-200 hover:shadow font-bold"
          title="ضخیم (Bold)"
        >
        ...
        <div className="relative">
          <button
            ...
            className="p-2 bg-white text-slate-700 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all border border-slate-200 shadow-sm hover:border-blue-200 hover:shadow flex items-center gap-1"
            title="رنگ متن"
          >
        ...
        <button
          ...
          className="p-2 bg-white text-slate-700 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all border border-slate-200 shadow-sm hover:border-red-200 hover:shadow"
          title="حذف فرمت‌ها"
        >
      ...
      <div
        ...
        className="p-4 min-h-[220px] max-h-[500px] overflow-y-auto outline-none text-slate-700 leading-relaxed text-base font-normal prose prose-slate max-w-none focus:outline-none rounded-b-2xl"
